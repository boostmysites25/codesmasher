      ...
      <div className="wrapper pt-[7rem] paddingbottom ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {getCurrentPortfolio().map((project) => (
            <div
              key={project.id}
              className="bg-white w-full dark:bg-darkblack rounded-lg shadow-primary/60 shadow-md overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              <img
                src={project.img}
                alt={project.title}
